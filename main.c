...
// Edit RTC Time (Hour, Minute, Second)

void rtc_edit(void){unsigned char i;
...
while(1)
{
    ...
    // Accept 2-digit hour input from keypad
...
}// Read 2-digit value from keypad// '*' = Backspace// '#' = Enter/Confirm

void get_2digit_value(unsigned int *value){unsigned char i=0;
...
void edit_hour(void){unsigned int value;
...
void edit_min(void){unsigned int value;
...
void rtc_menu(void){unsigned char page = 0;   // Menu page number
